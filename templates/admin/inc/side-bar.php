    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <div class="sidenav-header-inner text-center"><img src="/templates/admin/img/avatar-1.jpg" alt="person" class="img-fluid rounded-circle">
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li> <a href="/admin/user/"><i class="icon-user"></i><span>Quản lý người dùng</span></a></li>
